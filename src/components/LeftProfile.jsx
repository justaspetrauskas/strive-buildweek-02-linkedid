    ...
    <>
      <div id="profile-home-div" className="overflow-hidden border mt-5">
        ...
        <div className="name-title border-bottom text-center  pb-2 px-2">
          <a>
            <h6 id="name">{this.state.loading ? "loading" : this.state.user.name}
                <span> </span>
                {this.state.loading ? "loading" : this.state.user.surname}</h6>
          </a>
          <p className="text-muted"> {this.state.loading ? "loading" : this.state.user.title}</p>
          <div>
                {" "}
      ...
      <div id="profile-home-div" className="overflow-hidden border mt-3">
        ...
        <div className="premium  p-2">
          <br />
          <span className="font-weight-bold p-1" id='group'>Groups</span>
        </div>
        <div className="my-items p-2">
          <span className="font-weight-bold">
